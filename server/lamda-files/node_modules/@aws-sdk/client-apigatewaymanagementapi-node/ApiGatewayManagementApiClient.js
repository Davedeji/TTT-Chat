...
var ApiGatewayManagementApiConfiguration_1 = require("./ApiGatewayManagementApiConfiguration");
var ServiceMetadata_1 = require("./model/ServiceMetadata");
var ApiGatewayManagementApiClient = /** @class */ (function () {
    function ApiGatewayManagementApiClient(configuration) {
        this.middlewareStack = new __aws_sdk_middleware_stack.MiddlewareStack();
        this.config = __aws_sdk_config_resolver.resolveConfiguration(configuration, ApiGatewayManagementApiConfiguration_1.configurationProperties, this.middlewareStack);
    ...
    ApiGatewayManagementApiClient.prototype.send = function (command, cb) {
